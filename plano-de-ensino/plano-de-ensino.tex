...
\indent -- A opção \texttt{Contest email notification} faz com que a plataforma avise por e-mail sobre competições que estão por vir (\url{http://codeforces.com/settings/general}).
